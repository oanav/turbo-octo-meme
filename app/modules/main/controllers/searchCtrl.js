...
app.main.controller('SearchCtrl', ['$scope', '$window', '$location', 'SearchService', function ($scope, $window, $location, SearchService) {
    $scope.results = [];
        ...
        SearchService.searchByCategory(subcategory)
            .success(function (response) {
                ...
                $.each($scope.results, function (i, item) {
                    item.imagePath = '/modules/templates/' + item.path + '/snapshot.png';
                });
            })
